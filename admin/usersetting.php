        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="settings.php"><i class="fa fa-dashboard"></i>Table De Bord</a>
                    </li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Comptes<small> Administrateur </small>
                        </h1>
                    </div>
                </div> 
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Ajouter Nom et Mot De Passe</h4>
                                        </div>
										<form method="post">
                                        <div class="modal-body">
                                            <div class="form-group">
                                            <label>Nouveau Nom</label>
                                            <input name="newus"  class="form-control" placeholder="Enter Nom">
											</div>
										</div>
										<div class="modal-body">
                                            <div class="form-group">
                                            <label>Mot De Passe</label>
                                            <input name="newps"  class="form-control" placeholder="Enter Mot De Passe">
											</div>
                                        </div>
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel">Changer Nom et Mot De Passe</h4>
                                        </div>
										<form method="post">
                                        <div class="modal-body">
                                            <div class="form-group">
                                            <label>Changer Nom</label>
